window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function ComposerPicker({ locked, available, directory, load, select, t, useProjection, draft, onDraftChange, embedded, externalTargets = [], externalTargetsLabel = "External Agents", externalSelection, onExternalTargetChange, resolveInteractionOperations }) {
		...
		*/
		...
		function PlanReviewCard({ matched, directory, load, select, t, useProjection, locked = false, resolveInteractionOperations }) {
