window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function contextTierLabel(tier, tokens) {
			if (tier === null) return tokens === void 0 ? "标准" : formatWindow(tokens);
		...
		//#endregion
		//#region src/selection-feedback.ts
		...
		//#endregion
		//#region src/client/popup-dismissal.ts
		...
		*/
		...
		function ComposerPicker({ locked, available, directory, load, select, t, draft, onDraftChange, embedded, externalTargets = [], externalTargetsLabel = "External Agents", externalSelection, onExternalTargetChange, resolveInteractionOperations }) {
			...
			const applySelection = (next) => {
				...
				beginSelection(() => select(next), returnToRoot, settleSelection);
			};
		...
		var PlanReviewCard_module_css_default = {
			"executionLabel": "IJCTBG_executionLabel",
			...
			"execution": "IJCTBG_execution",
			"frame": "IJCTBG_frame",
			"body": "IJCTBG_body"
		};
		//#endregion
		//#region src/client/PlanReviewCard.tsx
		async function respondAnswer(wait, id, label) {
		...
		function PlanReviewCard({ matched, available, directory, load, select, t, useProjection, locked = false, resolveInteractionOperations }) {
			const review = (0, react.useMemo)(() => planReviewOf(matched.payload.questions), [matched]);
			const snapshot = (0, react.useSyncExternalStore)(directory.subscribe, directory.getSnapshot);
			...
			const onApprove = () => {
				if (execution === void 0 || !available) return;
				settle(async () => {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: PlanReviewCard_module_css_default.execution,
							"aria-label": t("plan.execution"),
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: PlanReviewCard_module_css_default.executionLabel,
								children: t("plan.execution")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ComposerPicker, {
								locked: locked || busy,
								available,
								directory,
								load,
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: [
									...
									review.decline !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										variant: "ghost",
										disabled: busy,
										...review.decline.description === void 0 ? {} : { title: review.decline.description },
										onClick: () => {
											settle(() => respondAnswer(matched, review.id, review.decline.label));
										},
										children: t("plan.keep")
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
										disabled: busy || !available || execution === void 0,
										onClick: onApprove,
